    ...
    <div class="container">
        <div class="row">
            <div class="col-12 table-responsive">
                <br />
                <h3 align="center">Laravel 9 CRUD Datatables Yajra Server Side (Create, Read, Upate and Delete) with
                    Bootstrap 5 Modal</h3>
                <br />
                <div align="right">
                ...
                <br />
                <table class="table table-striped table-bordered product_datatable">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>product Name</th>
