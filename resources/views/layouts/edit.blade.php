...
<body>
    <div class="w-4/5 mx-auto">
        ...
        <div class="m-auto pt-20">
            <div class="pb-8">
                @if ($errors->any())
                    <div class="bg bg-danger text-white font-bolded rounded-t px-4 py-2  ">
                        Something went wrong...
                    </div>

                    <ul class="border border-t-0 border-danger rounded-b  border-red-100 px-4 py-3 text-black">
            ...
            <form action="{{ route('blog.update', $post->id) }}" method="POST" {{-- (multipart required when you work with file upload) --}}
                ...
                <input type="checkbox" {{ $post->is_published === true ? 'checked' : '' }}
                    class="bg-transparent block border-b-2 inline text-2xl outline-none" name="is_published">
