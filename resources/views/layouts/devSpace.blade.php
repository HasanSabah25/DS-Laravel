...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <section class="content bg-light" style="background-color: rgb(157, 151, 151)">
                <div class="container-fluid">
                    <!-- Info boxes -->
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 table-responsive" style="background-color: #a09d9d">
                                        <br />
                                        <h3 align="center" class="text-white">CRUD Products With Yajra</h3>
                                        <br />
                                        <div align="right">
                                            <button type="button" name="create_record" id="create_record"
                                                class="btn btn-success"> <i class="bi bi-plus-square"></i> Add
                                            </button>
                                        </div>
                                        <br />
                                        <table class="table table-bordered product_datatable"
                                            style="background-color: #3c3a3a">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>product Name</th>
                                ...
                                <div class="modal fade" id="formModal" tabindex="-1" aria-labelledby="ModalLabel"
                                    aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            <form method="post" id="sample_form" class="form-horizontal">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group editproduct">
            ...
            $(document).on('click', '.edit', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#productquantity').val(data.result.productquantity);
                        $('#hidden_id').val(id);
